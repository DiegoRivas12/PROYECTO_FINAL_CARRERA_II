...
class Toxicity(evaluate.Measurement):
    ...
    def _download_and_prepare(self, dl_manager):
        if self.config_name == "default":
            ...
            logger.warning("Yes!")
            model_name = "../../../Models/toxicity/facebook/roberta-hate-speech-dynabench-r4-target"
        else:
            model_name = self.config_name

        self.toxic_classifier = pipeline("text-classification", model=model_name, top_k=99999, truncation=True, device=0)
